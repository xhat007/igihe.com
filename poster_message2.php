...
if(isset($_GET['id_article']) AND isset($_GET['id_forum'])){
	...
	//Fetch article title
		...
		if($expire<=$reload_after)
		{
			...
			$db=mysql_select_db('lex94_gh2016');			
		...
		<div>
			...
			<div class="gh_articlecommentsbox">
				...
				<table width="100%" height="*" cellspacing="0" cellpadding="0" border="0">
					...
					<tr>
						<td width="50%" align="left" valign="top" style="padding:5px;">
							<!-- <legend></legend> -->
							...
							<ul>
								<li class='saisie_texte'>
									...
									<textarea name="texte" id="texte_<?php echo $id_forum; ?>" class="gh_comments" style="width:350px;"></textarea>
								</li>
							</ul>
						</td>
						<td width="30%" align="left" valign="top" style="padding:5px;">
							...
							<!--------------------------------------------- -->
							<!-- HOPE THAT HERE YOU CAN SEE ME NOW -->
							<!--------------------------------------------- -->
			
							<!--------------------------------------------- -->
							<!--  END HOPE THAT HERE YOU CAN SEE ME NOW -->
							<!--------------------------------------------- -->
							<p class="boutons"><input type="submit" class="gh_commentssubmit" value="OHEREZA" onclick="envoyer_commentaire2(<?php echo $id_forum; ?>)" id="ohereza_<?php echo $id_forum; ?>"/></p>					
							<!--WASHERE-->
