...
.number2{min-width: 15px; text-align: center; padding: 5px; min-height: 10px; font-size: 20px; font-weight: bold; color: #fff; background: #000; margin-top: -227px; margin-left: 200px; position: absolute;}
	...
	<body>	
		...
		<?php						
		$cache='cache/moviesaward_vote_principe.html';
		$reload_after=30;
		$time_now=time();
							...
							<script type="text/javascript">
								...
								{								
									...
									else
									{
										...
										var method   = "POST";
										var filename = "moviesaward_votes.php";																	
								...
								<div style="width:100%;">											
								<?php 
								$poll=mysql_query('SELECT * FROM moviesaward_poll_questions LEFT JOIN moviesaward_poll ON moviesaward_poll_questions.question_poll_id=moviesaward_poll.poll_id ORDER BY question_poll_id,question_votes DESC');
