...
.number2{min-width: 15px; text-align: center; padding: 5px; min-height: 10px; font-size: 20px; font-weight: bold; color: #fff; background: #000; margin-top: -227px; margin-left: 200px; position: absolute;}
	...
	<body>	
		...
		<?php						
		$cache='cache/moviesawardactor_vote_principe.html';
		$reload_after=30;
		$time_now=time();
							...
							<script type="text/javascript">
								...
								{								
									...
									else
									{
										...
										var method   = "POST";
										var filename = "moviesawardactor_votes.php";																	
								...
								<div style="width:100%;">											
								<?php 
								$poll=mysql_query('SELECT * FROM moviesawardactor_poll_questions LEFT JOIN moviesawardactor_poll ON moviesawardactor_poll_questions.question_poll_id=moviesawardactor_poll.poll_id ORDER BY question_poll_id,question_votes DESC');
										...
										if($on_poll!=$get_poll['poll_id']){						
											...
											echo '<div style="text-align:center; float: left; width: 237px; margin-right: 2px; background: #000; padding-bottom: 10px; padding-top: 10px; border-bottom: 4px solid #fff;">
												<div>
													...
													<div style="width:34%;float:right;color:#ce851a;font-size:16px;padding-right: 5px;padding-top: 5px;text-align:right;"><span style="font-size:16px;">'.round($percentage_question,2).' %</span><br/>
		...
		echo'<div align="right" style="margin-top: -260px; margin-right: 32px;"><img src="http://igiheshowbiz.com/images/bactor.png"></div>';
		?>
	</body>
</html>
<?php
