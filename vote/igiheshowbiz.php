...
<div style="display:list-item;list-style-type:none;font-familly:levenim MT;font-size:16px;font-weight:bold;color:#D2EO8A;text-align:center;">RATING '.round($percentage_question,2).' %<br/><br/> <a href="#" onclick="send_vote('.$get_poll['poll_id'].','.$get_poll['question_id'].')">VOTE</a></div>
											...
											echo '<tr>
												<td width="147" style="text-align:center;">
													<a href="'.$get_poll['question_link'].'" title="view profile" target="_top"><img src="http://vote.igihe.com/images/ijororyurukundo/resized/'.$get_poll['question_image'].'" width="147" alt=""/></a>												

											</td>										
											<td style="background-color:609ebf;">
												<div style="float:left;width:48%;">
												<span style="color:#FFF;font-weight:bold;">'.$get_poll['question_profile'].'</span><br/>
												&nbsp;&nbsp;<a href="#" style="color:#FFF;font-size:12px;">'.$get_poll['question_title'].'</a>
												</div>		
...
<object type="application/x-shockwave-flash" data="http://www.igihe.com/squelettes/igihe_imgs/igihe_mp3_player.swf" width="170" height="25">
                    <param name="movie" value="http://www.igihe.com/squelettes/igihe_imgs/igihe_mp3_player.swf" />
                        <param name="bgcolor" value="#000000" />
						 <param name="wmode" value="transparent">
						<param name="FlashVars" value="mp3='.$get_poll['question_link'].'&amp;width=170&amp;height=25&amp;autoload=1&amp;showstop=1&amp;showvolume=1&amp;showloading=always&amp;buttonwidth=40&amp;sliderwidth=40&amp;sliderheight=15&amp;volumewidth=40&amp;volumeheight=10&amp;loadingcolor=167dc2&amp;bgcolor=000000&amp;bgcolor1=333333&amp;slidercolor1=cfcfcf&amp;slidercolor2=cfcfcf&amp;sliderovercolor=167dc2&amp;buttoncolor=cfcfcf&amp;buttonovercolor=167dc2" />
                </object>
												</div>
											</td>
											</tr>';
