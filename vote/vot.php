								...
								if($num_poll!=0){
									...
									do{
										...
										if($on_poll!=$get_poll['poll_id']){						
											...
											echo '<div style="width: 238px; float:left;" border="1">';												
											...
											echo '<div style="text-align:center; float: left; width: 238px; margin-right: 2px; background: #e4e6e5; padding-bottom: 10px; padding-top: 10px; border-bottom: 4px solid #fff;">
												<div>
													<div style=" width: 238px;height: 160px; overflow: hidden;">
