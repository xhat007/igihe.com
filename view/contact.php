...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e2e2e2', endColorstr='#ffffff',GradientType=0 ); /* IE6-9 */
	...
	<div id="rwdiaspora">
		...
		<div id="content2">
			<div class="c2" style="color: #fff;"><img src="images/c2.jpg" align="left" /><a class="sitemap" href="#">HOME</a> | <a class="sitemap" href="#">CONTACT US</a></div>
			<div class="content2lnews-log left">
				<div id="content1-profile" style="padding: 0px;">
					<div class="contact">
						<form>
							<label for="fname">FIRST NAME:</label>
							<input type="" name="" class="texte" id="fname" />
							<label for="lname">LAST NAME:</label>
							<input type="" name="" class="texte" id="lname" />
							<label for="email">EMAIL:</label>
							<input type="" name="" class="texte" id="email" />
							<label for="message">MESSAGE:</label>
							<textarea class="textareas" id="message"></textarea>
							<label>
								<input type="submit" value="SEND" class="submits"  />
							</label>
						</form>
						<div class="contact-info">
							<h2>CONTACTS</h2>
							<p>
								Location: Minafet Building 5th Floor - Kimihurura Kigali Rwanda<br /><br />
								PO Box: 179 Kigali-Rwanda<br /><br />
								Phones:<br />
								+250 788 74 44 46, +250 788 61 17 17<br /><br />
								Emails: <br />
								dgrca@minafet.gov.rw, info@rwandansabroad.gov.rw<br />
							</p>
						</div>
					</div>
				</div>
