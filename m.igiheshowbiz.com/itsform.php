...
if($move){
	...
	if(isset($_POST['nom']) AND isset($_POST['email']) AND isset($_POST['commentaire']) AND isset($_POST['id_forum']) AND isset($_POST['id_article']) AND isset($_POST['titre']))
	{
		...
		if($id_forum==0)
		{
			...
			echo '<b style="color:green;">Urakoze '.$nom_array[0].' kubw\'iciyumviro utanze! Nyuma y\' isuzumwa, kiragaragara ku muhora mu gihe kidatevye.</b>';
...
*/
	...
	echo 'haheze amasengonda ari munsi ya '.$time_to_recomment.' urungitse iciyumviro! Tegereza uze kwongera mukanya';
}
exit();
?>
