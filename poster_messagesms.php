...
if(isset($_GET['id_article']) AND isset($_GET['id_forum'])){
	...
	<form action="" method="post" enctype='multipart/form-data' onsubmit="return(false)" name="oForum">
		<div>
			<input type="hidden" name="id_forum" value="<?php echo $id_forum; ?>_<?php echo $id_article; ?>" />
			<!-- FORM -->
			<div class="gh_articlecommentsbox">
				<div id="comment_statut_<?php echo $id_forum; ?>_<?php echo $id_article; ?>" style="height:40px;">
				</div>
				<!------------------------------------------------------------------------------------------------------->
							...
							<fieldset>
								...
								<ul>
									<li class='saisie_texte'>
										...
										<textarea name="texte" id="texte_<?php echo $id_forum; ?>_<?php echo $id_article; ?>" class="gh_comments"></textarea>
									</li>
								</ul>
							</fieldset>
						</td>
...
<ul>
		<li class='saisie_session_nom'>
			...
			<input type="text" name="session_nom_<?php echo $id_forum; ?>_<?php echo $id_article; ?>" id="session_nom_<?php echo $id_forum; ?>_<?php echo $id_article; ?>" class="gh_comments" value=""  />
			
									</li>
									<li class='saisie_session_email'>
									<label for="session_email"><font class="gh_commentslabel">EMAIL YANYU</font></label>
									<input type="text" name="session_email_<?php echo $id_forum; ?>_<?php echo $id_article; ?>" id="session_email_<?php echo $id_forum; ?>_<?php echo $id_article; ?>" value="" class="gh_comments"  />
									</li>
								</ul>
							...
							<p class="boutons"><input type="submit" class="gh_commentssubmit" value="OHEREZA" onclick="envoyer_commentaire(<?php echo $id_forum; ?>,<?php echo $id_article; ?>)" id="ohereza_<?php echo $id_forum; ?>_<?php echo $id_article; ?>"/></p>					
							<!--WASHERE-->
						</td>
					</tr>
					<tr>
